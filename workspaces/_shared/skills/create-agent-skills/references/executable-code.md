...
<runtime_constraints>
Skills run in a code execution environment whose limitations vary by platform:
- Some environments allow installing packages from npm and PyPI at runtime
- Others have no network access and cannot install packages at runtime

Check what your target environment supports before relying on runtime installation.
</runtime_constraints>
