...
description: SKILL.md 撰写专家。创建、改良、结构化 skill。当需要新建 skill、改进或审查现有 SKILL.md、添加 workflow/reference/template/script 组件，或了解 skill 写法与最佳实践时使用。
---
...
All prompting best practices apply. Be clear, be direct, use XML structure. Assume the agent is smart - only add context the agent doesn't have.
